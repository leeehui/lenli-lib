...
Procedure CreateComponentINDM800X800X420L200X630N(Zero : integer);
Var
...
Begin
    Try
        ...
        NewPcbLibComp.Name := 'INDM800X800X420L200X630N';
        NewPCBLibComp.Description := 'Inductor, Molded Body; 8.00 mm L X 8.00 mm W X 4.20 mm H body';
        ...
        CreateSMDComponentPad(NewPCBLibComp, '1', eTopLayer, -3.2, 0, 0, 0, eRoundedRectangular, 2.81, 6.41, 180, 17.79, 0, 0, True, True);
        CreateSMDComponentPad(NewPCBLibComp, '2', eTopLayer, 3.2, 0, 0, 0, eRoundedRectangular, 2.81, 6.41, 0, 17.79, 0, 0, True, True);

        CreateComponentTrack(NewPCBLibComp, -2, 3.15, -2, -3.15, eMechanical12, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -2, -3.15, -4, -3.15, eMechanical12, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -4, -3.15, -4, 3.15, eMechanical12, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -4, 3.15, -2, 3.15, eMechanical12, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2, -3.15, 2, 3.15, eMechanical12, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 2, 3.15, 4, 3.15, eMechanical12, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 4, 3.15, 4, -3.15, eMechanical12, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 4, -3.15, 2, -3.15, eMechanical12, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -4, -4, -4, 4, eMechanical12, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -4, 4, 4, 4, eMechanical12, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 4, 4, 4, -4, eMechanical12, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, 4, -4, -4, -4, eMechanical12, 0.025, False);
        CreateComponentTrack(NewPCBLibComp, -4, -4, -4, 4, eMechanical11, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -4, 4, 4, 4, eMechanical11, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 4, 4, 4, -4, eMechanical11, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 4, -4, -4, -4, eMechanical11, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -4, 3.385, -4, 4, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 4, -3.385, 4, -4, eTopOverlay, 0.12, False);
        ...
        CreateComponentTrack(NewPCBLibComp, 4, -4, -4, -4, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -4, -4, -4, -3.385, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -4, 4, 4, 4, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, 4, 4, 4, 3.385, eTopOverlay, 0.12, False);
        CreateComponentTrack(NewPCBLibComp, -4.2, -4.2, 4.2, -4.2, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 4.2, -4.2, 4.2, -3.405, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 4.2, -3.405, 4.805, -3.405, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 4.805, -3.405, 4.805, 3.405, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 4.805, 3.405, 4.2, 3.405, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 4.2, 3.405, 4.2, 4.2, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, 4.2, 4.2, -4.2, 4.2, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -4.2, 4.2, -4.2, 3.405, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -4.2, 3.405, -4.805, 3.405, eMechanical15, 0.05, False);
        CreateComponentTrack(NewPCBLibComp, -4.805, 3.405, -4.805, -3.405, eMechanical15, 0.05, False);
...
Begin
    ...
    CreateComponentINDM800X800X420L200X630N(0);
End;
